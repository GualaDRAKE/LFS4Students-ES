...
|LSB Core:|install_initd, libcrypt.so.1 (puede proporcionarse con instrucciones opcionales<br> para el paquete LFS Libxcrypt),<br> libncurses.so.5 (puede proporcionarse con<br> instrucciones opcionales para el paquete LFS Ncurses), libncursesw.so.5<br> (pero libncursesw.so.6 lo proporciona el paquete LFS Ncurses)|
|:------------:|:----------------------------------------------------------:|
